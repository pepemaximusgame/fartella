...
export const MomoiExperience = () => {
    const [animation, setAnimation] = useState("Avatar_HOD_UR_Set02_LodP|HOD_UR_Set02_IdleShow.003");
 ...
 <Canvas camera={{ position: [0, 0, 15], fov: 45 }} >
    ...
    />
       <Momoi scale={5.4} animation={animation}/>
